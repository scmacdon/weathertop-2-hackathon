...
ECR_REPO_NAME = 'weathertop-java-ecr-repo'
IMAGE_TAG = 'latest'
DOCKERFILE_DIR = 'C:/Users/scmacdon/Docker/Java'  # Path to your Dockerfile/app

ECS_CLUSTER_NAME = 'MyJavaWeathertopCluster'
ECS_TASK_DEF_NAME = 'WeathertopJava'
CONTAINER_NAME = 'app'
...
LOG_GROUP = 'WeathertopJavaContainerLogs'
LOG_STREAM_PREFIX = 'weathertop-java-stream'
