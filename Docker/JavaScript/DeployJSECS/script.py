...
ECR_REPO_NAME = 'weathertop-js-ecr-repo'
IMAGE_TAG = 'latest'
DOCKERFILE_DIR = 'C:/Users/scmacdon/Docker/JavaScript'  # Path to your Dockerfile/app

ECS_CLUSTER_NAME = 'MyJSWeathertopCluster'
ECS_TASK_DEF_NAME = 'WeathertopJS'
CONTAINER_NAME = 'app'
...
EVENTBRIDGE_RULE_NAME = 'ecs-js-schedule'
...
def recreate_ecr_repo(repo_name):
    try:
        ...
        time.sleep(2)  # Adding a small delay to ensure the repository is deleted
...
def register_task_definition(image_uri):
    ...
    Ensures WORKDIR /tmp is used and Python runner is executed.
    """
    ...
    response = ecs.register_task_definition(
        ...
        containerDefinitions=[{
            ...
            'workingDirectory': '/tmp',   # ensure Python runs in /tmp
            'logConfiguration': {
                'logDriver': 'awslogs',
                'options': {
...
def main():
    ...
    # 3. Ensure ECR repo exists (recreate it each time)
