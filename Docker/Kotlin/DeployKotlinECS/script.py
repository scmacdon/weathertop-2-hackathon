...
ECR_REPO_NAME = 'weathertop-kotlin-ecr-repo'
IMAGE_TAG = 'latest'
DOCKERFILE_DIR = 'C:/Users/scmacdon/Docker/Kotlin'  # Path to your Dockerfile/app
...
EVENTBRIDGE_RULE_NAME = 'ecs-kotlin-schedule'
