...
ECR_REPO_NAME = 'weathertop-net-ecr-repo'
IMAGE_TAG = 'latest'
DOCKERFILE_DIR = 'C:/Users/scmacdon/Docker/NET'  # Path to your Dockerfile/app

ECS_CLUSTER_NAME = 'MyNetWeathertopCluster'
ECS_TASK_DEF_NAME = 'WeathertopNet'
CONTAINER_NAME = 'app'
...
LOG_GROUP = 'WeathertopNetContainerLogs'
LOG_STREAM_PREFIX = 'weathertop-net-stream'
