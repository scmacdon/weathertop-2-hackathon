...
ECR_REPO_NAME = 'weathertop-python-ecr-repo'
IMAGE_TAG = 'latest'
DOCKERFILE_DIR = 'C:/Users/scmacdon/Docker/Python'  # Path to your Dockerfile/app

ECS_CLUSTER_NAME = 'MyPythonWeathertopCluster'
ECS_TASK_DEF_NAME = 'WeathertopPython'
CONTAINER_NAME = 'app'
...
EVENTBRIDGE_RULE_NAME = 'ecs-python-schedule'
