...
ECR_REPO_NAME = 'weathertop-ruby-ecr-repo'
IMAGE_TAG = 'latest'
DOCKERFILE_DIR = 'C:/Users/scmacdon/Docker/Ruby'  # Path to your Dockerfile/app

ECS_CLUSTER_NAME = 'MyRubyWeathertopCluster'
ECS_TASK_DEF_NAME = 'WeathertopRuby'
CONTAINER_NAME = 'app'
...
LOG_GROUP = 'WeathertopRubyContainerLogs'
LOG_STREAM_PREFIX = 'weathertop-ruby-stream'

EVENTBRIDGE_RULE_NAME = 'ecs-ruby-schedule'
