...
IMAGE_TAG = 'latest'
DOCKERFILE_DIR = 'C:/Users/scmacdon/Docker/Rust'  # Path to your Dockerfile/app

ECS_CLUSTER_NAME = 'MyRustWeathertopCluster'
ECS_TASK_DEF_NAME = 'WeathertopRust'
CONTAINER_NAME = 'app'
...
LOG_GROUP = 'WeathertopRustContainerLogs'
LOG_STREAM_PREFIX = 'weathertop-rust-stream'

EVENTBRIDGE_RULE_NAME = 'ecs-rust-schedule'
